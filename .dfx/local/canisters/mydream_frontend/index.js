...
import { idlFactory } from './mydream_frontend.did.js';
export { idlFactory } from './mydream_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MYDREAM_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./mydream_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the mydream_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./mydream_frontend.did.js")._SERVICE>}
 */
export const mydream_frontend = createActor(canisterId);
