...
import { idlFactory } from './mydream_backend.did.js';
export { idlFactory } from './mydream_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MYDREAM_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./mydream_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the mydream_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./mydream_backend.did.js")._SERVICE>}
 */
export const mydream_backend = createActor(canisterId);
