...
import { idlFactory } from './mydream_be.did.js';
export { idlFactory } from './mydream_be.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MYDREAM_BE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./mydream_be.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the mydream_be canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./mydream_be.did.js")._SERVICE>}
 */
export const mydream_be = createActor(canisterId);
