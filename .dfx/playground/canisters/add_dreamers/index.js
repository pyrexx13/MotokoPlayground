...
import { idlFactory } from './add_dreamers.did.js';
export { idlFactory } from './add_dreamers.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ADD_DREAMERS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./add_dreamers.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the add_dreamers canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./add_dreamers.did.js")._SERVICE>}
 */
export const add_dreamers = createActor(canisterId);
