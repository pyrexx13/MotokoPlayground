...
import { idlFactory } from './full_dao.did.js';
export { idlFactory } from './full_dao.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FULL_DAO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./full_dao.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the full_dao canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./full_dao.did.js")._SERVICE>}
 */
export const full_dao = createActor(canisterId);
