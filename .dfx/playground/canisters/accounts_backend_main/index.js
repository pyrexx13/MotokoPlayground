...
import { idlFactory } from './accounts_backend_main.did.js';
export { idlFactory } from './accounts_backend_main.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ACCOUNTS_BACKEND_MAIN_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./accounts_backend_main.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the accounts_backend_main canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./accounts_backend_main.did.js")._SERVICE>}
 */
export const accounts_backend_main = createActor(canisterId);
